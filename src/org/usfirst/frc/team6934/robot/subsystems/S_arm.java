...
public class S_arm extends Subsystem {
	 ...
	 *
	 * @deprecated This was mostly a guess of what would remove the kickstands. The physical kickstands didn't cooperate super well
	 ...
	 * reach the scale and thus, this is unlikely to be useful.
	 */
	...
	/**
	 * A hacky, manual scaling method that attempts to round the input values in order to make the input less finicky
